...
function App() {
  ...
  useEffect(() => {
        fetch('https://instaclonebackend-yz2f.onrender.com/getposts') //insta-backend-3sch.onrender.com
  ...
  return (
   <>
    <header id='header'><div id='fix'><div id='head'><img id='logo' alt='logo' src={insta}>
